...
$result = mysqli_query(
$con,
"SELECT * FROM `laptops` WHERE `code`='$code'"
);
...
<div class="headder">
    ...
    <div class="navbar">
      <ul>
        ...
        <li><a href="cart.php"><img src="cart-icon.png"/>
<?php
if(!empty($_SESSION["shopping_cart"])) {
...
<h2 class="mobiles">Our Selection of Laptops</h2>
<?php
$result = mysqli_query($con,"SELECT * FROM `laptops` LIMIT 0,8");
...
<h2 class="laptops"></h2>
<?php
$result = mysqli_query($con,"SELECT * FROM `laptops` LIMIT 8,8");
while($row = mysqli_fetch_assoc($result)){
...
<h2 class="laptops"></h2>
<?php
$result = mysqli_query($con,"SELECT * FROM `laptops` LIMIT 16,24");
while($row = mysqli_fetch_assoc($result)){
